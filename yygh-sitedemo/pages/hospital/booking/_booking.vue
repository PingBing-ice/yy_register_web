  ...
  <div class="nav-container page-component">
    ...
    <div class="nav left-nav">
      <div class="nav-item selected">
        <span class="v-link selected dark" @click="yygh(schedule.hoscode)">预约挂号 </span>
      </div>
      <div class="nav-item ">
        <span class="v-link clickable dark" @click="yyxq(schedule.hoscode)"> 医院详情 </span>
      </div>
      <div class="nav-item">
        <span class="v-link clickable dark" @click="yyxz(schedule.hoscode)"> 预约须知 </span>
      </div>
...
import hospitalApi from '@/api/yy/hospital'
import patientApi from '@/api/yy/patient'
import orderInfoApi from "@/api/yy/orderinfo";
