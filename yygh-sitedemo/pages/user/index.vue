    ...
    <div class="page-container">
      <div>
        ...
        <div class="form-wrapper" v-if="userInfo.authStatus === 0">
          <div>
            <el-form   :model="userAuah" :rules="rules" label-width="110px" label-position="left">
...
import dictApi from '@/api/yy/dict'
import userInfoApi from '@/api/yy/userInfo'
const defaultForm = {
  name: '',
  certificatesType: '',
  certificatesNo: '',
...
export default {
  data() {
    return {
      ...
      fileUrl:'http://localhost:8222/oss/file/upload',
      userInfo: {
        param: {}
      },
      submitBnt: '提交',
  ...
  methods: {
    ...
    getDict() {
      dictApi.findByDictCode("CertificatesType").then(response => {
        this.certificatesTypeList = response.data.dictList
      })
    },
