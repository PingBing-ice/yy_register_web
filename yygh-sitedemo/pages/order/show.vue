  ...
  <div class="nav-container page-component">
    ...
    <div class="page-container">
      <div class="order-detail">
        ...
        <div class="bottom-wrapper mt60" v-if="orderInfo.orderStatus === 0 || orderInfo.orderStatus === 1 || orderInfo.orderStatus ===2 ">
          <div class="button-wrapper">
            <div class="v-button white" @click="cancelOrderButton()">取消预约</div>
          </div>
...
import orderInfoApi from '@/api/yy/order'
import wxApi from "@/api/yy/wx";
import wx from "@/api/yy/wx";
export default {
  data() {
    return {
      orderId: null,
  ...
  methods: {
    init() {
      orderInfoApi.getOrderInfoById(this.orderId).then(response => {
    ...
    cancelOrderButton() {
      ...
      this.$confirm('确定取消预约吗?', '提示', {
        ...
        // 点击确定，远程调用
        return wx.cancelOrder(this.orderId)
      }).then((response) => {
