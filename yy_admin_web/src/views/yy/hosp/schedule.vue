<template>
  <div class="app-container">
    ...
    <el-container style="height: 100%">
      ...
      <div v-if="bookingScheduleList.length>0" style="padding: 0 0 0 20px;">
        <el-main>
      ...
      <div v-if="bookingScheduleList.length===0" style="width: 100%">
        <el-divider content-position="center">该科室无排班</el-divider>
      </div>
    </el-container>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getScheduleRule() {
      schedule.getSchedule(this.page, this.limit, this.hoscode, this.depcode).then(response => {
